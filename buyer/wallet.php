...
<div class="grid">
  ...
  <section class="card span-5">
    ...
    <form method="post" class="form-grid" style="margin-bottom:18px" data-withdrawal-form data-bank-url="../api/wallet-banks.php" data-resolve-url="../api/resolve-bank-account.php">
      ...
      <label>Withdrawal Method<select name="withdraw_provider" data-provider><option value="monnify">Monnify withdrawal</option><option value="paystack">Paystack withdrawal</option></select></label>
      ...
      <div class="wide"><button class="btn" type="submit" name="request_withdrawal" data-submit-withdrawal disabled><i class="fas fa-money-bill-transfer"></i> Submit Monnify/Paystack Withdrawal</button></div>
    </form>
