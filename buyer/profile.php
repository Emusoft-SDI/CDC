...
?>
<style>.password-field{position:relative;display:block}.password-field input{padding-right:74px}.password-toggle{position:absolute;right:8px;top:50%;transform:translateY(-50%);border:0;border-radius:7px;background:#eef8ef;color:#06451f;padding:8px 10px;font-weight:900;cursor:pointer;width:auto}</style><div class="page-head"><div><h1>Buyer Profile & Security</h1><p>Manage contact details, delivery preferences, profile photo, and password.</p></div></div>
...
<div class="grid">
  ...
  <form method="post" class="card form-grid span-4">
    ...
    <label class="wide">Current Password<span class="password-field"><input id="buyer-current-password" type="password" name="current_password" required autocomplete="current-password"><button class="password-toggle" type="button" data-toggle-password="buyer-current-password">Show</button></span></label>
    <label class="wide">New Password<span class="password-field"><input id="buyer-new-password" type="password" name="new_password" required minlength="8" autocomplete="new-password"><button class="password-toggle" type="button" data-toggle-password="buyer-new-password">Show</button></span></label>
    <label class="wide">Confirm Password<span class="password-field"><input id="buyer-confirm-password" type="password" name="confirm_password" required minlength="8" autocomplete="new-password"><button class="password-toggle" type="button" data-toggle-password="buyer-confirm-password">Show</button></span></label>
