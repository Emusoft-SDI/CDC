    ...
    <div class="header-container">
      ...
      <nav>
        <ul class="nav-menu">
          ...
          <li><details><summary>Categoriesâ–¾</summary><div class="mk-dropdown"><?php foreach ($categoryMenu as $cat): ?><a href="index.php?category_id=<?= (int) $cat['id'] ?>"><?= e((string) $cat['name']) ?></a><?php endforeach; ?><?php if (!$categoryMenu): ?><a href="index.php">All Categories</a><?php endif; ?></div></details></li>
          ...
          <li><details><summary>Shop by State â–¾</summary><div class="mk-dropdown"><?php foreach ($stateMenu as $state): ?><a href="index.php?state=<?= rawurlencode((string) $state['state_name']) ?>"><?= e((string) $state['state_name']) ?></a><?php endforeach; ?><?php if (!$stateMenu): ?><a href="index.php">All States</a><?php endif; ?></div></details></li>
