...
{
    return [
        'general_seller' => 'General Marketplace Seller',
        'grower' => 'Grower / Farm Owner',
        'cooperative' => 'Cooperative',
        'farm_hand' => 'Farm Hand / Practical Worker',
        'agronomist' => 'Agronomist',
        'extensionist' => 'Agricultural Extensionist',
        'input_provider' => 'Input Seller / Supplier',
        'service_provider' => 'Service Seller',
...
function marketplace_ensure_operational_columns(PDO $pdo): void
{
    ...
    foreach ([
        ...
        'operator_delivery_note' => "TEXT NULL",
...
function marketplace_user_default_seller_type(array $user): string
{
    ...
    return match ($role) {
        ...
        'seller', 'marketplace_seller' => 'general_seller',
        default => 'general_seller',
    };
}
