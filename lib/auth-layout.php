...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .otp-grid { display:grid; grid-template-columns:repeat(6, minmax(0, 1fr)); gap:10px; margin:18px 0 0; width:100%; max-width:100%; overflow:hidden; }
    .otp-grid input { width:100%; min-width:0; height:52px; text-align:center; font-size:1.25rem; font-weight:900; margin:0; padding:8px 2px; border-radius:9px; line-height:1; }
    .copyright { position:absolute; left:clamp(28px, 7vw, 86px); bottom:34px; color:#777; font-size:.9rem; }
    @media (max-width:420px) { .otp-grid { gap:6px; } .otp-grid input { height:44px; font-size:1.08rem; } }
