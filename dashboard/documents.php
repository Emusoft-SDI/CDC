    ...
    if (!verify_csrf($_POST['_csrf'] ?? null)) {
        ...
        if ($error === '') {
            ...
            if ($appId > 0 && canIssueCertificate($userId, $pdo)) {
                ...
                $message = 'Documents saved and your certificate has been issued. Open Certificates to pay any required access or renewal fee before viewing or downloading.';
            }
        }
    }
}
