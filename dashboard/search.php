...
$roleKeys = market_user_role_keys($pdo, $currentUser);
...
$catalog = [
    ...
    ['title' => 'Seller Central', 'description' => 'Manage seller profile, listings, orders, and sales.', 'href' => '../market/seller-central.php', 'feature' => 'marketplace', 'roles' => ['seller','marketplace_seller'], 'tags' => 'seller central store orders products listings'],
