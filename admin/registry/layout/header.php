...
.sidebar-logo { width:40px; height:40px; background:#fff; border-radius:10px; display:flex; align-items:center; justify-content:center; overflow:hidden; flex-shrink:0; }
...
<aside class="sidebar">
  ...
  <div class="nav-section">
    ...
    <a class="nav-item <?= $activeNav === 'profile' ? 'active' : '' ?>" href="profile.php">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z"/><path d="M6 20c0-2.21 2.69-4 6-4s6 1.79 6 4"/></svg>
      <span>Profile</span>
    </a>
...
<div class="main">
  <div class="topbar">
    ...
    <div class="topbar-actions">
      <button class="topbar-profile" type="button" data-topbar-toggle>
      ...
      <div class="topbar-menu" id="topbarMenu">
        ...
        <a href="profile.php#account">Account Settings</a>
