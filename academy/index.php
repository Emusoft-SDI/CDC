  ...
  <header class="top">
    <div class="bar">
      ...
      <nav class="nav" aria-label="Academy navigation">
        ...
        <?php if ($user): ?><a href="dashboard.php">Learner Dashboard</a><a class="btn" href="logout.php">Log Out</a><?php else: ?><a href="../login.php?next=academy/dashboard.php">Login</a><a class="btn" href="register.php">Register as Learner</a><?php endif; ?>
      </nav>
    </div>
  </header>
